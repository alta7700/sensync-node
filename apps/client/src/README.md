...
- `App.tsx` содержит runtime singleton, рекурсивный renderer `row/column/widget`, локальные modal forms, toast-уведомления и ECharts/canvas графики, включая history-режим с data-zoom для viewer-профилей.
